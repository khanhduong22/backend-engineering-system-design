# 01_SQL_PostgreSQL_Mastery - SQL & PostgreSQL Mastery Study Guide
...
#### 2. Analyze common SQL syntax errors regarding DDL and DML operations.
**Answer:**
...
#### 3. Are Views and tables in the same namespace?
**Answer:**
In MySQL, Views and tables share the same namespace.

#### 4. Are all database views updateable?
**Answer:**
...
#### 11. Can subqueries be used in constraints?
**Answer:**
...
#### 14. Can you query a table using only schema.name (e.g., HumanResources.Employee)?
**Answer:**
...
#### 19. Compare EXEC(SQL) and sp_executesql.
**Answer:**
...
#### 21. Compare the strictness of Fourth Normal Form (4NF) and Boyce-Codd Normal Form (BCNF).
**Answer:**
...
#### 23. Define Boyce-Codd Normal Form (BCNF).
**Answer:**
...
#### 24. Define Boyce-Codd normal form (BCNF).
**Answer:**
...
#### 25. Define Drill-down and Roll-up operations in OLAP.
**Answer:**
...
#### 26. Define Full Functional Dependency.
**Answer:**
...
#### 27. Define Functional Dependency.
**Answer:**
...
#### 29. Define a 'Query' and 'Query Language' in the context of a DBMS.
**Answer:**
...
#### 30. Define a database transaction.
**Answer:**
...
#### 31. Define common SQL constraints: NOT NULL, UNIQUE, FOREIGN KEY, CHECK, PRIMARY KEY, and DEFAULT.
**Answer:**
...
#### 32. Define fifth normal form (5NF).
**Answer:**
...
#### 33. Define first normal form (1NF).
**Answer:**
...
#### 37. Define the Query Executor (QE) in a database engine.
**Answer:**
...
#### 38. Define the Query Optimizer (QO) and its objective.
**Answer:**
...
#### 39. Define the following SQL DDL and DML commands: CREATE DATABASE, CREATE TABLE, CREATE INDEX, DROP TABLE, SELECT, INSERT INTO, UPDATE, and ALTER DATABASE.
**Answer:**
...
#### 40. Define the relationship between a foreign key and a primary key.
**Answer:**
...
#### 41. Define the terms 'data', 'information', 'database', and 'DBMS'.
**Answer:**
...
#### 42. Define third normal form (3NF).
**Answer:**
...
#### 43. Describe the basic components of a relational database structure.
**Answer:**
...
#### 44. Describe the different types of SQL Joins.
**Answer:**
...
#### 45. Describe your experience as a SQL Server DBA.
**Answer:**
...
#### 46. Difference between actual and estimated execution plan in SSMS?
**Answer:**
...
#### 47. Difference between execution plan and query plan?
**Answer:**
...
#### 48. Difference between index rebuild and reorganize?
**Answer:**
...
#### 49. Do Hash Match, Merge Join, and Nested Loop operators require a memory grant?
**Answer:**
...
#### 50. Do database privileges always reside within the database system itself?
**Answer:**
...
#### 51. Do execution plans have priority in server memory?
**Answer:**
...
#### 52. Does COUNT(myCol) count all rows in a column? What happens with NULLs?
**Answer:**
No. COUNT(column_name) ignores NULL values in that column. Use COUNT(*) to count all rows regardless of NULLs.

#### 53. Does a row have to fit on one page?
**Answer:**
...
#### 54. Does serializability guarantee a specific execution order?
**Answer:**
...
#### 55. Explain 'Complete' vs 'Incomplete' and 'Disjoint' vs 'Overlapping' subclassing.
**Answer:**
...
#### 56. Explain CROSS, LEFT, RIGHT, and FULL OUTER JOINS.
**Answer:**
...
#### 57. Explain Document, Graph, and Key/Value databases.
**Answer:**
...
#### 58. Explain HIERARCHYID functions: GetAncestor, GetDescendant, GetLevel, GetReparentedValue, ToString, GetRoot, and Parse.
**Answer:**
...
#### 59. Explain date/time data types (date, datetime, datetime2) and ISO8601 formatting.
**Answer:**
...
#### 60. Explain how filtering works with NULL values and inclusion lists.
**Answer:**
...
#### 61. Explain the 4NF and BCNF decomposition algorithms.
**Answer:**
...
#### 62. Explain the AND, OR, and NOT logical operators.
**Answer:**
...
#### 63. Explain the ANY and ALL operators.
**Answer:**
...
#### 64. Explain the BETWEEN operator and provide an example.
**Answer:**
...
#### 65. Explain the COUNT aggregate function.
**Answer:**
...
#### 66. Explain the GROUP BY and HAVING clauses.
**Answer:**
...
#### 67. Explain the LIKE operator and provide an example.
**Answer:**
...
#### 68. Explain the SQL COUNT(), AVG(), and SUM() functions.
**Answer:**
...
#### 69. Explain the UNION and UNION ALL operators.
**Answer:**
...
#### 70. Explain the XPath expression //Book[@Price < 90].
**Answer:**
...
#### 71. Explain the common types of joins in SQL.
**Answer:**
...
#### 72. Explain the comparison, null, pattern match, range, and set membership conditions in a WHERE clause.
**Answer:**
...
#### 73. Explain the difference between COUNT(*), COUNT(column_name), and COUNT(DISTINCT column_name).
**Answer:**
...
#### 74. Explain the difference between Conceptual, Logical, and Physical data models.
**Answer:**
...
#### 75. Explain the difference between FULL JOIN and CROSS JOIN.
**Answer:**
...
#### 76. Explain the difference between JOIN types (e.g., INNER, LEFT, RIGHT) using the Invoices/Customers scenario.
**Answer:**
...
#### 77. Explain the differences between Conceptual, Logical, and Physical data models.
**Answer:**
...
#### 78. Explain the differences between Slicing and Dicing in OLAP cubes.
**Answer:**
...
#### 79. Explain the different types of database Normalization (1NF, 2NF, 3NF).
**Answer:**
...
#### 80. Explain the different types of indexes in SQL.
**Answer:**
...
#### 81. Explain the effect of CASCADE and RESTRICT in authorization revocation.
**Answer:**
...
#### 82. Explain the normalization rules (1NF, 2NF, 3NF) using Codd's rule.
**Answer:**
The data depends on the key (1NF), the whole key (2NF), and nothing but the key (3NF).

#### 83. Explain the primary SQL clauses: SELECT, FROM, WHERE, GROUP BY, HAVING, ORDER BY.
**Answer:**
...
#### 84. Explain the use of single and double quotation marks in SQL.
**Answer:**
...
#### 85. Find all records in the movie table with a title beginning with a letter A through J.
**Answer:**
SELECT * FROM movie WHERE title BETWEEN 'A' AND 'J'; or SELECT * FROM movie WHERE title LIKE '[A-J]%';

#### 86. Find each employee's first_name, last_name, city, and state from the employee and location tables using the location_id field.
**Answer:**
...
#### 87. Find employees by department, displaying department, employee_id, salary, and the calculated average_salary_by_department using a window function.
**Answer:**
SELECT depname, empno, salary, AVG(salary) OVER (PARTITION BY depname) AS average_salary_by_department FROM empsalary;

#### 88. Find how many films begin with the letter 'J'.
**Answer:**
SELECT COUNT(*) FROM films WHERE title LIKE 'J%';

#### 89. Find in the payments table the customer_id of customers who have spent (amount) at least $110 with the staff_id of 2, grouped by customer.
**Answer:**
...
#### 90. Find the app in the app table with the most downloads.
**Answer:**
SELECT MAX(downloads) FROM app;

#### 91. Find the customer with the highest customer_id whose first_name starts with 'E' and has an address_id lower than 500.
**Answer:**
SELECT first_name, last_name FROM customers WHERE first_name LIKE 'E%' AND address_id < 500 ORDER BY customer_id DESC LIMIT 1;

#### 92. Find the names of the owners of the cat with id 3, using tables cat, owner, and join table cat_owner.
**Answer:**
SELECT owner.name FROM owner INNER JOIN cat_owner ON owner.id = cat_owner.owner_id WHERE cat_owner.cat_id = 3;

#### 93. Find the number of apps at each price in the apps table.
**Answer:**
SELECT price, COUNT(*) FROM apps GROUP BY price;

#### 94. Find the number of downloads per category.
**Answer:**
SELECT category, SUM(downloads) FROM app GROUP BY category;

#### 95. Find the number of employees in the employee table with the first_name Lisa or David. Do not use an OR statement.
**Answer:**
SELECT * FROM employee WHERE first_name IN ('Lisa', 'David');

#### 96. Find the number of records in the app table that have a price of 0.
**Answer:**
SELECT COUNT(*) FROM app WHERE price = 0;

#### 97. Find the salary of each employee and the running total of salaries in ascending order.
**Answer:**
SELECT salary, SUM(salary) OVER (ORDER BY salary) AS running_total FROM empsalary;

#### 98. Find the salary of each employee and the total sum of all salaries, displaying both in every row.
**Answer:**
SELECT salary, SUM(salary) OVER () FROM empsalary;

#### 99. Find the salary rank by department of each employee using a window function.
**Answer:**
SELECT depname, empno, salary, RANK() OVER (PARTITION BY depname ORDER BY salary DESC) FROM empsalary;

#### 100. Find the sum of all amounts in the payment table.
**Answer:**
...
#### 101. Find the three lowest rated movies from the movies table.
**Answer:**
SELECT * FROM movies ORDER BY rating ASC LIMIT 3;

#### 102. Find websites in the approved_websites table that match the pattern: starts with ftp:// or http://, ends in .org, and has at least one character before the :// and one character after.
**Answer:**
SELECT * FROM approved_websites WHERE url_name LIKE '_%://_%.org';

#### 103. For a fact table with attributes D1, D2, and D3, what are the row count formulas for GROUP BY, CUBE, and ROLLUP?
**Answer:**
Q1 (GROUP BY): n1*n2*n3. Q2 (WITH CUBE): (n1+1)*(n2+1)*(n3+1). Q3 (WITH ROLLUP): (n1*n2*n3) + (n1*n2) + n1 + 1.

#### 104. Functional dependencies are a generalization of what concept?
**Answer:**
Functional dependencies are a generalization of the notion of keys.

#### 105. Funkce LAG(), LEAD() a LAST_VALUE()
**Answer:**
...
#### 106. Generally, when a view includes aggregation (such as avg), does it make sense to allow modifications over this view?
**Answer:**
...
#### 107. Granting and Revoking Privileges
**Answer:**
...
#### 108. How are A->>B and A->B read in database theory?
**Answer:**
A->B is read as 'A determines B'. A->>B is read as 'A multi-determines B'.

#### 109. How are Extended Events results stored?
**Answer:**
...
#### 110. How are GRANT and REVOKE used in SQL?
**Answer:**
...
#### 111. How are Integrity Constraints classified in SQL?
**Answer:**
...
#### 112. How are NoSQL databases structured compared to relational databases?
**Answer:**
...
#### 113. How are PFS pages allocated in SQL Server?
**Answer:**
Every 8,088th page is a Page Free Space (PFS) page.

#### 114. How are SQL comments implemented?
**Answer:**
...
#### 115. How are XQuery and XSLT defined in relation to XPath?
**Answer:**
...
#### 116. How are column concatenation and aliasing performed in SQL?
**Answer:**
...
#### 117. How are computed columns implemented?
**Answer:**
...
#### 118. How are data records ordered in index leaves?
**Answer:**
Data in index leaf nodes is ordered by the Clustered Key (CK).

#### 119. How are database functions invoked?
**Answer:**
Functions can be invoked within SELECT, INSERT, or UPDATE statements.

#### 120. How are date and time handled in SQL?
**Answer:**
...
#### 125. How are relationships represented in a join table?
**Answer:**
...
#### 126. How are row offsets stored on a page?
**Answer:**
They are stored at the end of the data page in a slot array, ordered backwards.

#### 127. How are rows from two or more tables combined based on a common field?
**Answer:**
Using SQL Joins.

#### 128. How are stored procedures executed?
**Answer:**
...
#### 135. How can one handle null bitmaps in indexes?
**Answer:**
...
#### 136. How can stored procedures or functions improve application performance?
**Answer:**
...
#### 137. How can the order of execution be defined for AFTER triggers in SQL Server?
**Answer:**
By using sp_settriggerorder to specify 'FIRST', 'LAST', or 'NONE' (undefined).

#### 138. How can you aggregate multiple rows into a single comma-separated string?
**Answer:**
...
#### 142. How can you identify rows in one table that have no matching records in another?
**Answer:**
...
#### 143. How can you reduce network traffic between applications and the database?
**Answer:**
...
#### 144. How can you simulate a MAX() function using set operators?
**Answer:**
...
#### 145. How can you temporarily rename a table or a column heading?
**Answer:**
Using SQL Aliases (typically via the AS keyword).

#### 146. How can you test if a string value is a valid 'datetime' in SQL Server?
**Answer:**
...
#### 147. How can you validate if a string represents a valid date?
**Answer:**
Use the ISDATE(expression) function, which returns 1 if the expression is a valid date format and 0 otherwise.

#### 148. How do B-trees and Hash tables compare as indexing structures?
**Answer:**
...
#### 149. How do DBMS handle queries against virtual views?
**Answer:**
...
#### 150. How do ER models map to natural language and database structure?
**Answer:**
...
#### 151. How do GROUP BY and HAVING clauses work in aggregation?
**Answer:**
...
#### 152. How do Hash tables compare to Balanced Trees in database indexing?
**Answer:**
...
#### 153. How do NOT BETWEEN and NOT IN operators work in SQL?
**Answer:**
...
#### 154. How do NoSQL databases compare to traditional relational (RDBMS) systems?
**Answer:**
...
#### 155. How do SQL and NoSQL databases differ in approach to structure?
**Answer:**
...
#### 156. How do SQL and NoSQL databases scale differently?
**Answer:**
...
#### 157. How do aggregate functions handle NULL values?
**Answer:**
...
#### 158. How do constraints relate to triggers?
**Answer:**
...
#### 159. How do implicit data type mismatches impact index performance?
**Answer:**
...
#### 160. How do indexes affect AND versus OR operators?
**Answer:**
...
#### 161. How do materialized views improve database performance?
**Answer:**
...
#### 162. How do rows in intermediate pages differ between UNIQUE and non-UNIQUE indexes?
**Answer:**
...
#### 163. How do table variables behave within a transaction in SQL Server?
**Answer:**
They do not participate in or respect the transactional rollback mechanism.

#### 164. How do the LIKE operator and the underscore (_) wildcard function?
**Answer:**
...
#### 165. How do you add a new column to an existing table?
**Answer:**
Use the ALTER TABLE statement: ALTER TABLE table_name ADD COLUMN column_name data_type;

#### 166. How do you add a new row to a database table?
**Answer:**
Use the INSERT INTO statement: INSERT INTO table_name (col1, col2) VALUES (val1, val2);

#### 167. How do you add a row to a database table and handle the primary key?
**Answer:**
...
#### 168. How do you add or remove a column from a table?
**Answer:**
...
#### 169. How do you add up the number of items per category?
**Answer:**
SELECT category, SUM(column_name) FROM table_name GROUP BY category;

#### 170. How do you alias columns and count rows in SQL?
**Answer:**
...
#### 171. How do you calculate the difference between two dates and how do you add intervals to a date?
**Answer:**
...
#### 177. How do you connect to a specific database in PostgreSQL?
**Answer:**
Use the command \c database_name.

#### 178. How do you count entries, filter by nulls, and query for unique values?
**Answer:**
...
#### 179. How do you count the number of entries in a table?
**Answer:**
Use the COUNT() function: SELECT COUNT(*) FROM table_name;

#### 180. How do you count the number of items per category?
**Answer:**
Use the COUNT() aggregate function combined with a GROUP BY clause: SELECT price, COUNT(*) FROM fake_apps GROUP BY price;

#### 181. How do you create a many-to-many relationship in a relational database?
**Answer:**
...
#### 182. How do you create a table in SQL?
**Answer:**
...
#### 183. How do you create and drop databases in SQL?
**Answer:**
...
#### 184. How do you create and drop tables in SQL?
**Answer:**
...
#### 185. How do you create statistics for computed values (e.g., A*B)?
**Answer:**
...
#### 186. How do you create tables with primary keys and foreign key constraints in SQL?
**Answer:**
...
#### 187. How do you define a custom data type with specific constraints?
**Answer:**
...
#### 188. How do you define and use functions in SQL?
**Answer:**
...
#### 189. How do you define the database context for a query?
**Answer:**
Use the USE command (e.g., 'USE database_name;').

#### 190. How do you determine if a set of Functional Dependencies (FDs) S2 follows from S1?
**Answer:**
...
#### 191. How do you drop common database constraints?
**Answer:**
...
#### 192. How do you edit a row in a table?
**Answer:**
Use the UPDATE command: 'UPDATE table_name SET col_name = new_value WHERE id = target_id;'

#### 193. How do you ensure data in a column is valid JSON?
**Answer:**
Use a CHECK constraint with the ISJSON() function, e.g., CHECK (ISJSON(column_name) = 1).

#### 194. How do you exclude a character from your result set?
**Answer:**
Use the NOT operator within the LIKE clause and brackets. For example: SELECT * FROM Employee WHERE LastName LIKE 'O[^S]%'.

#### 195. How do you expose statistics for table variables to the query optimizer?
**Answer:**
Use the OPTION(RECOMPILE) query hint.

#### 196. How do you extract components (Year, Month, Day) from a date, and how do you reconstruct a date or datetime from those parts?
**Answer:**
...
#### 197. How do you filter data using basic comparison, logical operators (AND/OR), and 'IN' clauses?
**Answer:**
...
#### 198. How do you filter records based on NULL values or empty spending (Samnt)?
**Answer:**
...
#### 199. How do you filter rows in a SQL table based on specific conditions for numeric values, null values, or patterns?
**Answer:**
...
#### 200. How do you find all candidate keys given a set of functional dependencies (FDs)?
**Answer:**
...
#### 201. How do you find employee names starting with 'A'?
**Answer:**
SELECT * FROM Table_name WHERE EmpName LIKE 'A%'

#### 202. How do you force the SQL optimizer to consider indexes on a view?
**Answer:**
Use the WITH (NOEXPAND) table hint in the query.

#### 203. How do you handle NULL values in SQL?
**Answer:**
...
#### 204. How do you handle column names with spaces in SQL?
**Answer:**
Use double quotes ("alias") or square brackets ([alias]) to delimit the column name.

#### 205. How do you handle concatenation and data types in SQL functions?
**Answer:**
...
#### 206. How do you handle special characters (like quotes or wildcards) in SQL queries?
**Answer:**
...
#### 207. How do you handle special characters like a single quote in a string literal?
**Answer:**
Use an escape character by doubling the single quote (e.g., 'Mc''Donald').

#### 208. How do you implement conditional logic in a SELECT statement?
**Answer:**
Use the CASE expression: CASE WHEN condition THEN result ELSE default END. It allows row-by-row categorization of data.

#### 209. How do you include duplicate rows when using a UNION operator?
**Answer:**
Use UNION ALL instead of UNION (which defaults to distinct values only).

#### 210. How do you join tables to retrieve related data?
**Answer:**
...
#### 211. How do you make changes permanent in a database?
**Answer:**
The COMMIT statement is used to finalize and persist all changes made during the current transaction.

#### 212. How do you manage output and session state in the SQLite CLI?
**Answer:**
...
#### 213. How do you manage transactions in PostgreSQL?
**Answer:**
...
#### 214. How do you manage views in SQL?
**Answer:**
...
#### 215. How do you match characters not specified within brackets in a SQL pattern match?
**Answer:**
Use the [^charlist] or [!charlist] syntax within the LIKE operator to exclude specific characters.

#### 216. How do you modify existing data in a table?
**Answer:**
The UPDATE statement is used to change existing values in one or more columns of a table.

#### 217. How do you modify table structure using the ALTER TABLE command?
**Answer:**
...
#### 218. How do you perform a LEFT JOIN and when is it typically used?
**Answer:**
...
#### 219. How do you perform basic aggregations on a table?
**Answer:**
...
#### 220. How do you perform basic selection, sorting, and limiting of results?
**Answer:**
...
#### 221. How do you perform date and time comparisons in SQL queries?
**Answer:**
...
#### 222. How do you perform joins in SQL?
**Answer:**
...
#### 223. How do you perform pattern matching in SQL?
**Answer:**
The LIKE clause is used with wildcard characters (like % or _) to search for a specific pattern in a string column.

#### 224. How do you perform text manipulation like extraction and replacement in MS SQL?
**Answer:**
...
#### 227. How do you query a subset of columns from a table?
**Answer:**
Specify the required column names in the SELECT clause: SELECT col1, col2 FROM table_name;

#### 228. How do you query an alphabetically ordered list of names with their profession first letter in parentheses, and a count of occurrences for each occupation in SQL?
**Answer:**
...
#### 229. How do you query data from multiple tables simultaneously?
**Answer:**
Use a JOIN clause (INNER, LEFT, RIGHT, or FULL).

#### 230. How do you query for a single quote inside a string literal?
**Answer:**
You must escape the single quote by adding another single quote before it. Example: SELECT * FROM Grant WHERE GrantName LIKE '%' '%'.

#### 231. How do you query for multiple characters using wildcards?
**Answer:**
Use brackets to define character sets or ranges. Examples: LIKE '[ABCDE]%' or LIKE '[A-K]%'.

#### 232. How do you query for special characters like % and _ literally?
**Answer:**
...
#### 233. How do you query for unique values in a specific column?
**Answer:**
Use the DISTINCT keyword: SELECT DISTINCT column_name FROM table_name;

#### 234. How do you remove duplicate values when performing an aggregation?
**Answer:**
The DISTINCT keyword is used inside aggregate functions (e.g., COUNT(DISTINCT column_name)) to consider only unique values.

#### 235. How do you rename columns when using SELECT INTO to create a new table?
**Answer:**
You can use the AS clause to alias column names in the output table.

#### 236. How do you retrieve the third-highest salary from an employee table?
**Answer:**
SELECT TOP 1 salary FROM (SELECT TOP 3 salary FROM employee_table ORDER BY salary DESC) AS emp ORDER BY salary ASC;

#### 237. How do you retrieve the three lowest rated movies?
**Answer:**
SELECT * FROM movies ORDER BY imdb_rating ASC LIMIT 3;

#### 238. How do you retrieve unique values from a column?
**Answer:**
...
#### 239. How do you select values within a range in SQL?
**Answer:**
Using the BETWEEN operator.

#### 240. How do you simulate universal quantification ('for all') in XPath?
**Answer:**
...
#### 241. How do you store special characters (like Chinese or other non-Latin scripts) in a database table?
**Answer:**
...
#### 245. How do you translate an association with 1..1 or 0..1 multiplicity into relations?
**Answer:**
...
#### 246. How do you update an existing row in a database table?
**Answer:**
Use the UPDATE statement with a WHERE clause: UPDATE table_name SET col1 = val1 WHERE id = x;

#### 247. How do you use the SQL DELETE statement?
**Answer:**
...
#### 248. How do you write comments in SQL?
**Answer:**
Use double hyphens (--) for single-line comments.

#### 249. How does COUNT(*) differ from COUNT(column_name)?
**Answer:**
...
#### 250. How does ROLLUP aggregation work?
**Answer:**
...
#### 251. How does SQL Server Service Broker handle failed message delivery?
**Answer:**
...
#### 255. How does XSD compare to DTD?
**Answer:**
...
#### 256. How does a covering index improve performance compared to a full table scan?
**Answer:**
...
#### 257. How does a database fetch data after jumping to a secondary index vs. a covering index?
**Answer:**
...
#### 258. How does a filtered index behave in a stored procedure?
**Answer:**
...
#### 259. How does multiple INNER JOIN syntax work, and what should you watch out for?
**Answer:**
...
#### 260. How does parameter sniffing occur with variables in SQL queries?
**Answer:**
...
#### 261. How does relational algebra handle duplicates?
**Answer:**
...
#### 262. How does the BETWEEN operator work in a WHERE clause?
**Answer:**
...
#### 263. How does the LIKE operator use wildcards?
**Answer:**
...
#### 264. How does the LIKE operator work for pattern matching in SQL?
**Answer:**
...
#### 265. How does the Query Optimizer improve a trivial execution plan?
**Answer:**
It uses internal transformation rules to rewrite and optimize the plan.

#### 266. How does the WHERE clause function in SQL?
**Answer:**
...
#### 267. How does the cardinality estimator order multiple predicates?
**Answer:**
It orders them based on selectivity, which is the fraction of rows that satisfy a predicate.

#### 268. How does using stored procedures or functions improve security?
**Answer:**
...
#### 269. How is a one-to-one relationship implemented in database design?
**Answer:**
...
#### 270. How is cache space for query plans managed?
**Answer:**
...
#### 271. How is cardinality represented in database design?
**Answer:**
...
#### 272. How is existential quantification ("there exists") handled in XQuery?
**Answer:**
...
#### 273. How is the DROP INDEX statement used?
**Answer:**
...
#### 274. How is the NULL bitmap size calculated?
**Answer:**
It is 2 bytes plus 1 byte for every 8 nullable columns in the table.

#### 275. How is the closure of attributes computed in functional dependency theory?
**Answer:**
...
#### 276. How is the duration of an operator calculated in query plans?
**Answer:**
It is calculated as: Time of Close() call - Time of Init() call.

#### 277. How is the level numbering system structured in an index tree?
**Answer:**
The leaf level is defined as level 0, and the root page is assigned the maximum number.

#### 278. How is the variable array stored in a record?
**Answer:**
...
#### 279. How is transaction isolation level scope defined?
**Answer:**
...
#### 280. How is universal quantification expressed in XQuery?
**Answer:**
Universal quantification ("for all") is expressed by checking if every item in a sequence satisfies a specific condition.

#### 281. How large is a Record Identifier (RID)?
**Answer:**
8 bytes.

#### 282. How large is a forwarding pointer?
**Answer:**
16 bytes.

#### 283. How large is a lock structure?
**Answer:**
96 bytes.

#### 284. How large is one quantum in SQL Server scheduling?
**Answer:**
4 ms.

#### 285. How large is the variable-length column array?
**Answer:**
It is 2 bytes plus 2 bytes for each variable-length column present.

#### 286. How many IAM pages exist in SQL Server?
**Answer:**
...
#### 287. How many navigation axes exist in XPath?
**Answer:**
There are 13 navigation axes in XPath (e.g., child, parent, descendant, ancestor, etc.).

#### 288. How many pages fit in one Megabyte?
**Answer:**
128 pages (since each page is 8KB).

#### 289. How many primary and unique keys can a table have?
**Answer:**
A table can have only one primary key, but it can have one or more unique keys.

#### 290. How many rows are in an intermediate index level?
**Answer:**
One for each page of the next lower level in the index tree.

#### 291. How many tempdbs exist on one instance of SQL Server?
**Answer:**
Only one.

#### 292. How many values are tracked in a standard SQL histogram?
**Answer:**
200 steps (values).

#### 293. How many values can be returned by a user-defined function?
**Answer:**
A scalar user-defined function returns exactly one value.

#### 294. How much I/O overhead does a RID lookup cost?
**Answer:**
One I/O normally, or two if a forwarding pointer must be followed.

#### 295. How much data fits on one standard SQL Server data page?
**Answer:**
8,060 bytes.

#### 296. How much memory does SQL Server grant for a variable-length column?
**Answer:**
It typically grants 50% of the declared size.

#### 297. How much overhead does the 'read committed snapshot' isolation option add per row?
**Answer:**
14 bytes per row for the version pointer.

#### 298. How much space do views consume?
**Answer:**
Views consume very little space because the database only stores the definition of the view, not the data it presents.

#### 299. How should database transactions be designed regarding locks?
**Answer:**
...
#### 300. How should words in a column name be separated?
**Answer:**
...
#### 301. How should you correctly identify NULL values in SQL?
**Answer:**
...
#### 302. How to delete records with empty values in a specific column?
**Answer:**
Use the DELETE statement with an IS NULL condition: DELETE FROM celebs WHERE twitter_handle IS NULL;

#### 303. How to enumerate over a set for multiple values in a query?
**Answer:**
Use the IN operator. For example: SELECT * FROM Employee WHERE FirstName IN ('Lisa', 'David').

#### 304. How to handle NULL values in expressions using functions?
**Answer:**
Use IFNULL() or COALESCE() to return an alternative value if the input expression evaluates to NULL (e.g., COALESCE(column, 0)).

#### 305. How to remove duplicates from a SELECT result set?
**Answer:**
Use the DISTINCT keyword: SELECT DISTINCT column_name FROM table_name.

#### 306. How to sort results by a specific column?
**Answer:**
Use the ORDER BY clause, optionally specifying ASC or DESC: SELECT * FROM movies ORDER BY imdb_rating DESC;

#### 307. If a functional dependency A -> all attributes exists, what is A?
**Answer:**
A is a candidate key for the relation.

#### 308. In MySQL, what keyword allows an automatic view update to ensure modifications appear within the view constraints?
**Answer:**
...
#### 309. In Relational Algebra, what is the difference between joining/cross-product and union operators?
**Answer:**
...
#### 310. In SQL Service Broker, what happens if a ROUTE does not define a BROKER_INSTANCE and multiple services share the same name?
**Answer:**
The message is delivered to one of the services randomly, a behavior often used for scaling out.

#### 311. In UML class modeling, what are the alternative terms for subclass and superclass?
**Answer:**
A subclass is also called a 'Specialization', and a superclass is also called a 'Generalization'.

#### 312. In XQuery, what is the difference between 'For' and 'Let'?
**Answer:**
...
#### 313. In XSLT, how is the current element referenced?
**Answer:**
The current element is referenced using the '.' character.

#### 314. In a relationship between fruit_table and apple_table where fruit_table is the parent: (1) Which table needs a foreign key? (2) What does it correspond to? (3) Which is the child? (4) How is the relationship described?
**Answer:**
...
#### 315. In boolean logic, how do TRUE and FALSE compare, and what is the result of comparing a value with NULL or an UNKNOWN state?
**Answer:**
TRUE is greater than FALSE. Any comparison involving NULL or an UNKNOWN truth value results in an UNKNOWN result.

#### 316. In the context of database system development, what does the functional/application area refer to?
**Answer:**
...
#### 317. In the relational model, what determines the domain of values for an attribute?
**Answer:**
...
#### 318. In which clause can a subquery be used?
**Answer:**
A subquery can be used in many places, most commonly in the WHERE clause, but also in the SELECT, FROM, and HAVING clauses.

#### 319. In which version was the Cardinality Estimator first changed in SQL Server?
**Answer:**
It was updated in SQL Server 2014 (compatibility level 120).

#### 320. Is decomposing a relation into BCNF or 4NF always the best design choice?
**Answer:**
...
#### 321. Is it always possible to propagate data modifications from a view to the underlying base tables?
**Answer:**
...
#### 322. Is it possible to index LOB columns?
**Answer:**
...
#### 323. Is recursion with aggregation allowed in the SQL standard?
**Answer:**
...
#### 324. Is the BETWEEN clause inclusive or exclusive?
**Answer:**
Inclusive. BETWEEN 'A' AND 'C' includes both A and C.

#### 325. Is the order of clauses in an SQL SELECT statement flexible?
**Answer:**
...
#### 326. Is the splitting rule valid for the left-hand side attributes of functional dependencies?
**Answer:**
No, the splitting rule (decomposition) applies only to the right-hand side of a functional dependency.

#### 327. Jak klasifikovat funkční závislosti A->B?
**Answer:**
...
#### 354. S čím souvisí rozhodnutí použít materializované pohledy (materialized views)?
**Answer:**
Rozhodnutí je otázkou kompromisu mezi rychlostí čtení (query) a režií při zápisu (update), podobně jako u indexů.

#### 355. SQL Aggregation Functions (MIN, MAX)
**Answer:**
...
#### 356. SQL Constraints: PRIMARY KEY and NOT NULL
**Answer:**
...
#### 357. SQL INSERT INTO SELECT Statement
**Answer:**
...
#### 359. SQL JOINs: INNER, LEFT, RIGHT, and FULL
**Answer:**
...
#### 360. SQL LIKE Operator and Wildcards
**Answer:**
...
#### 361. SQL NULL Values and Handling
**Answer:**
...
#### 362. SQL Programmability: Views and Triggers
**Answer:**
...
#### 363. SQL Recursive Queries (WITH)
**Answer:**
...
#### 368. Tell me the top downloaded app.
**Answer:**
SELECT MAX(downloads) FROM fake_apps;

#### 369. The EXCEPT operator can be practically replaced by what?
**Answer:**
...
#### 370. True or False: A PRIMARY KEY can consist of more than one column.
**Answer:**
True. This is known as a composite primary key.

#### 371. True or False: The BETWEEN operator behaves identically across all database systems.
**Answer:**
...
#### 376. What are DBCC commands in T-SQL?
**Answer:**
...
#### 377. What are DMVs (Dynamic Management Views)?
**Answer:**
...
#### 378. What are INSTEAD OF triggers?
**Answer:**
...
#### 379. What are Integrity Constraints?
**Answer:**
...
#### 380. What are LOBs (Large Objects) and LOB pages in a database?
**Answer:**
...
#### 381. What are Magic Tables (Inserted/Deleted) in SQL Server?
**Answer:**
...
#### 382. What are Physical Design Advisors?
**Answer:**
...
#### 383. What are ROLLUP and CUBE in T-SQL?
**Answer:**
...
#### 385. What are SQL Compound Operators?
**Answer:**
...
#### 387. What are SQL constraints and why are they used?
**Answer:**
...
#### 388. What are SQL constraints and why are they used?
**Answer:**
...
#### 390. What are SQL parameters and why are they important?
**Answer:**
...
#### 391. What are approximate numeric data types used for?
**Answer:**
...
#### 392. What are column constraints and common examples?
**Answer:**
...
#### 393. What are common DBCC commands for query tuning and debugging?
**Answer:**
...
#### 394. What are common SQL Server trace flags for performance tuning?
**Answer:**
...
#### 395. What are common database design anomalies?
**Answer:**
...
#### 396. What are common date and time functions for constructing or calculating dates?
**Answer:**
...
#### 397. What are common date and time functions for extracting parts of a date?
**Answer:**
...
#### 398. What are common pattern matching and range operators in SQL?
**Answer:**
...
#### 399. What are common problems with file-based storage compared to databases?
**Answer:**
...
#### 400. What are common psql utility commands for session management?
**Answer:**
\c (connect to database), \password (change user password), \conninfo (connection details), \q (quit), \? (list all commands).

#### 401. What are critical considerations for a Business Intelligence (BI) project?
**Answer:**
...
#### 402. What are database constraints and why are they used?
**Answer:**
...
#### 403. What are domain, field, and NULL constraints?
**Answer:**
...
#### 404. What are general database assertions?
**Answer:**
...
#### 405. What are incremental statistics?
**Answer:**
...
#### 406. What are insertion, update, and deletion anomalies?
**Answer:**
...
#### 409. What are primary and foreign keys?
**Answer:**
...
#### 410. What are some common types of non-relational (NoSQL) databases?
**Answer:**
Common types include Key-value databases, Document databases, and Graph databases.

#### 411. What are some standard SQL data types?
**Answer:**
...
#### 412. What are sql_statement_starting/completed/recompile in Extended Events?
**Answer:**
...
#### 413. What are tables in the context of a database?
**Answer:**
Tables are named database objects organized into rows and columns used to store data.

#### 414. What are temporary tables and how do local differ from global ones?
**Answer:**
...
#### 415. What are the ACID properties in a database?
**Answer:**
...
#### 416. What are the ACID properties in a database?
**Answer:**
...
#### 417. What are the ACID properties of database transactions?
**Answer:**
...
#### 418. What are the ACID properties of database transactions?
**Answer:**
...
#### 424. What are the advantages of non-linear recursion versus linear recursion?
**Answer:**
...
#### 425. What are the advantages of using Cursors?
**Answer:**
...
#### 426. What are the basic CRUD operations in SQL?
**Answer:**
...
#### 427. What are the basic constructs of XML?
**Answer:**
XML consists of nested tagged elements, attributes, and text content.

#### 428. What are the basic constructs used in XPath?
**Answer:**
...
#### 429. What are the benefits of using a database view?
**Answer:**
...
#### 430. What are the best practices for choosing database data types?
**Answer:**
Choose smaller data types where possible, keep types simple, and avoid NULL values if the business logic allows.

#### 431. What are the characteristics of the decimal(p, s) data type in MS SQL?
**Answer:**
...
#### 432. What are the commands to manage access privileges?
**Answer:**
...
#### 433. What are the common PostgreSQL CLI meta-commands?
**Answer:**
...
#### 434. What are the common Relational Algebra operators?
**Answer:**
...
#### 435. What are the common SQL aggregate functions?
**Answer:**
...
#### 436. What are the common SQL constraints used to maintain data integrity?
**Answer:**
...
#### 437. What are the common SQL date and time types?
**Answer:**
The five common types are: DATE, TIME, DATETIME, TIMESTAMP, and YEAR.

#### 438. What are the common anomalies that occur in unnormalized relations?
**Answer:**
...
#### 439. What are the common categories of data?
**Answer:**
...
#### 440. What are the common commands in the SQLite CLI to manage tables and schemas?
**Answer:**
.tables (list tables), .schema (show table/database structure).

#### 441. What are the common complications and constraints associated with using aggregations in SQL?
**Answer:**
...
#### 442. What are the common drawbacks of using XSLT?
**Answer:**
...
#### 443. What are the common referential actions for foreign keys?
**Answer:**
...
#### 444. What are the common schema descriptor languages for XML?
**Answer:**
...
#### 445. What are the common strategies for translating UML subclasses into relations?
**Answer:**
...
#### 446. What are the common string manipulation functions in SQL (LEN, LEFT, RIGHT, SUBSTRING, CHARINDEX, CONCAT, REPLACE, STUFF, LTRIM, RTRIM)?
**Answer:**
...
#### 447. What are the common transaction isolation levels?
**Answer:**
...
#### 448. What are the common tricky issues associated with database triggers?
**Answer:**
...
#### 449. What are the common types of SQL joins and how do they function?
**Answer:**
...
#### 452. What are the core characteristics of a parameter in SQL?
**Answer:**
A parameter in SQL is defined by its name and its specific data type.

#### 453. What are the core components of a database table?
**Answer:**
...
#### 454. What are the core components of the Relational Engine?
**Answer:**
...
#### 455. What are the core datatypes in SQLite?
**Answer:**
...
#### 456. What are the core elements of SQL?
**Answer:**
...
#### 457. What are the core features of a Database Management System (DBMS)?
**Answer:**
...
#### 458. What are the core functions of a relational database as defined by Edgar Codd?
**Answer:**
...
#### 459. What are the desirable properties of decomposition?
**Answer:**
Attribute preservation, dependency preservation, and lossless decomposition.

#### 460. What are the disadvantages of failing to normalize a database?
**Answer:**
...
#### 461. What are the disadvantages of using Cursors in SQL?
**Answer:**
...
#### 462. What are the downsides of using indexes?
**Answer:**
...
#### 463. What are the four main types of integrity constraints?
**Answer:**
...
#### 464. What are the four possible referencing-variables available in database triggers?
**Answer:**
...
#### 465. What are the fundamental CRUD statements for a table?
**Answer:**
...
#### 466. What are the fundamental characteristics of Relational databases?
**Answer:**
...
#### 467. What are the ideal conditions for a Nested Loop join operator?
**Answer:**
...
#### 468. What are the inputs of a Hash Match operator?
**Answer:**
The top input is the 'build' input, and the bottom input is the 'probe' input.

#### 469. What are the key best practice guidelines for database index design?
**Answer:**
...
#### 470. What are the main components of an ERD (Entity Relationship Diagram)?
**Answer:**
An ERD consists of Entities, their Attributes, and the relationships (often defined by foreign keys) between them.

#### 471. What are the main elements/components of a database?
**Answer:**
...
#### 472. What are the main string data types in MS SQL and their primary characteristics?
**Answer:**
...
#### 473. What are the main types of table relationships?
**Answer:**
...
#### 474. What are the mandatory clauses in a SELECT statement?
**Answer:**
The SELECT and FROM clauses are mandatory.

#### 475. What are the maximum limits for index keys in SQL Server?
**Answer:**
...
#### 476. What are the most basic elements/objects of a relational database?
**Answer:**
...
#### 477. What are the options for maintaining Referential Integrity when a primary key is modified?
**Answer:**
...
#### 478. What are the parts of a PL/SQL block?
**Answer:**
...
#### 479. What are the phases of the Database Life Cycle in sequence?
**Answer:**
1. Scoping, 2. Conceptual Database Design, 3. Relational Database Design, 4. Normalization, 5. Physical Database Design.

#### 480. What are the phases of the Database Life Cycle?
**Answer:**
...
#### 481. What are the physical implications of data modification on indexes and pages?
**Answer:**
...
#### 482. What are the possible states of a worker thread in a database engine?
**Answer:**
The typical states for a worker thread are: running, runnable (waiting for a processor), and suspended (waiting for a resource).

#### 483. What are the primary PostgreSQL command-line (psql) shortcuts to list database objects?
**Answer:**
\l (databases), \d or \d+ (tables), \dn or \dn+ (schemas), \df (functions), \du (users).

#### 484. What are the primary SQL DDL commands?
**Answer:**
DDL includes CREATE, ALTER, and DROP commands for Schemas, Tables, Views, and Domains.

#### 485. What are the primary SQL commands used to modify the contents of a database table?
**Answer:**
...
#### 486. What are the primary data types supported by PostgreSQL?
**Answer:**
...
#### 487. What are the primary motivations behind NoSQL databases?
**Answer:**
...
#### 488. What are the primary motivations for using database views?
**Answer:**
...
#### 489. What are the primary reasons for database normalization?
**Answer:**
...
#### 490. What are the primary subsets of SQL?
**Answer:**
...
#### 491. What are the primary targets of database normalization?
**Answer:**
...
#### 492. What are the primary underlying data structures for database indexes?
**Answer:**
...
#### 493. What are the primary use cases for triggers?
**Answer:**
...
#### 494. What are the properties of the 'Read Committed' isolation level?
**Answer:**
...
#### 495. What are the properties of the 'Repeatable Read' isolation level?
**Answer:**
...
#### 496. What are the pros and cons of using Materialized Views?
**Answer:**
...
#### 497. What are the reasons for early statement termination during plan compilation?
**Answer:**
...
#### 498. What are the requirements for 1NF, 2NF, 3NF, and BCNF?
**Answer:**
...
#### 499. What are the requirements for First Normal Form (1NF)?
**Answer:**
...
#### 500. What are the requirements for a Primary Key?
**Answer:**
A Primary Key must contain a unique value for every row and cannot contain NULL values.

#### 501. What are the requirements for a view to be automatically updatable under the SQL standard?
**Answer:**
...
#### 502. What are the requirements for using UNION in SQL?
**Answer:**
...
#### 506. What are the rules for a well-formed XML document?
**Answer:**
...
#### 507. What are the sql:column() and sql:variable() functions?
**Answer:**
...
#### 508. What are the standard SQL aggregate functions?
**Answer:**
...
#### 509. What are the steps to execute a cursor?
**Answer:**
1. Declare cursor, 2. Open cursor, 3. Fetch row, 4. Process row, 5. Close cursor, 6. Deallocate cursor.

#### 510. What are the storage characteristics and statistical differences between temporary tables and table variables?
**Answer:**
...
#### 511. What are the three SQL keywords used for procedure/function parameters?
**Answer:**
IN (input only), OUT (output only), and IN OUT (input and output).

#### 512. What are the three core parts of a PL/SQL block?
**Answer:**
...
#### 513. What are the three main areas of SQL statements?
**Answer:**
...
#### 514. What are the three main categories of data types in relational databases?
**Answer:**
...
#### 515. What are the three structured database approaches?
**Answer:**
...
#### 516. What are the trade-offs of using indexes on a table?
**Answer:**
...
#### 517. What are the two ISO standard mechanisms for domain constraints?
**Answer:**
The CHECK clause and the CREATE DOMAIN statement.

#### 518. What are the two primary activities in database planning?
**Answer:**
Defining the mission statement and defining the mission objectives.

#### 519. What are the two primary approaches for managing view modifications in a DBMS?
**Answer:**
...
#### 520. What are the two primary goals of database authorization?
**Answer:**
...
#### 521. What are the two primary motivations for implementing database transactions?
**Answer:**
Transactions are motivated by two independent concepts: Concurrency control and Resilience against system failure.

#### 522. What are the two types of PL/SQL subprograms?
**Answer:**
PL/SQL supports Stored Procedures and Functions.

#### 523. What are the two types of database triggers?
**Answer:**
...
#### 524. What are the typical steps of database system development?
**Answer:**
1. Database planning, 2. System definition, 3. Requirements collection and analysis, 4. Database design, 5. DBMS selection.

#### 525. What are the various Join types available in T-SQL?
**Answer:**
...
#### 526. What are trivial functional dependencies?
**Answer:**
If A->B and B is a subset of A, then the dependency is trivial. This implies A -> (A union B) and A -> (A intersect B).

#### 527. What are two common SQL Injection payloads that evaluate to 'Always True'?
**Answer:**
...
#### 528. What causes the 'ERROR 666' in SQL Server?
**Answer:**
...
#### 536. What condition must be met for a view to be updateable?
**Answer:**
...
#### 537. What data type do we use when we want to define points in time to a certain degree of accuracy?
**Answer:**
Date and Time data types (e.g., DATETIME, TIMESTAMP, DATE).

#### 538. What data type represents truth values?
**Answer:**
The Boolean data type, which holds the values TRUE and FALSE.

#### 539. What data types can be used with the BETWEEN operator?
**Answer:**
BETWEEN can be used to select a range of numbers, text, or dates.

#### 540. What defines a 'good' decomposition of a relation?
**Answer:**
...
#### 541. What defines the Second Normal Form (2NF)?
**Answer:**
...
#### 544. What do SQL commands INSERT, SELECT, UPDATE, and DELETE do?
**Answer:**
INSERT adds a new record, SELECT retrieves data, UPDATE modifies existing records, and DELETE removes records from a table.

#### 545. What do common SQL Server wait types signify: CX_PACKET, CXCONSUMER, and RESOURCE_SEMAPHORE?
**Answer:**
...
#### 546. What do sys.indexes.index_id values represent?
**Answer:**
...
#### 547. What do the 'data_type' and 'size' parameters specify in a CREATE TABLE statement?
**Answer:**
...
#### 548. What do the SQL Server internal engines (Apolon, Hekaton, Relation) do?
**Answer:**
...
#### 549. What do the UPDATE, ALTER, CREATE, and DROP commands do?
**Answer:**
...
#### 555. What does CRUD stand for in database operations?
**Answer:**
...
#### 560. What does RDBMS stand for?
**Answer:**
Relational Database Management System.

#### 561. What does SCOPE_IDENTITY() return?
**Answer:**
It returns the last identity value generated in the current session and the current scope.

#### 562. What does SQL mainly allow us to do?
**Answer:**
...
#### 563. What does SQL stand for?
**Answer:**
Structured Query Language.

#### 564. What does SQL stand for?
**Answer:**
SQL stands for Structured Query Language.

#### 565. What does a COMMIT statement do?
**Answer:**
It permanently saves the changes made during the current transaction to the database.

#### 566. What does a SELECT statement do and what does it return?
**Answer:**
...
#### 567. What does a bit string consist of?
**Answer:**
A sequence of binary digits, limited to the values 0 and 1.

#### 568. What does an INSERT INTO ... SELECT statement do?
**Answer:**
...
#### 573. What does it mean for a transaction to be atomic?
**Answer:**
...
#### 574. What does it mean for columns to have integrity enhancement?
**Answer:**
...
#### 575. What does it mean to 'type' a table?
**Answer:**
...
#### 576. What does sys.dm_exec_query_statistic_XML(session_id) do?
**Answer:**
...
#### 577. What does the 'WITH CHECK OPTION' do in a view?
**Answer:**
...
#### 578. What does the 'impact' value in a missing index hint signify?
**Answer:**
It represents the estimated percentage improvement in query performance if the recommended index were created.

#### 579. What does the ACID acronym stand for in transaction management?
**Answer:**
...
#### 580. What does the Atomicity property guarantee in a database transaction?
**Answer:**
...
#### 583. What does the CAP theorem describe?
**Answer:**
...
#### 591. What does the ORDER BY clause do?
**Answer:**
...
#### 592. What does the ROUND function do?
**Answer:**
...
#### 593. What does the SQL keyword 'BEFORE' indicate in a trigger?
**Answer:**
...
#### 594. What does the UNION clause do?
**Answer:**
...
#### 595. What does the UPDATE statement do?
**Answer:**
...
#### 596. What does the UPDATE(column) function do within a trigger?
**Answer:**
It returns a boolean value indicating whether the specified column was modified in the SET clause of a DML statement.

#### 597. What does the WITH clause (Common Table Expression) do?
**Answer:**
...
#### 598. What does the acronym ACID stand for?
**Answer:**
...
#### 602. What does the expression '{...}' mean in XQuery?
**Answer:**
...
#### 606. What factors determine the effectiveness of an index?
**Answer:**
...
#### 607. What happens if a Service Broker route is only configured on the initiator?
**Answer:**
...
#### 608. What happens if a stored procedure expecting a Table-Valued Parameter (TVP) is called without one?
**Answer:**
The parameter will be treated as an empty table.

#### 609. What happens if you disable a clustered index?
**Answer:**
Access to the entire table is disabled in most SQL implementations.

#### 610. What happens if you omit columns during an INSERT INTO operation?
**Answer:**
...
#### 611. What happens when an INNER JOIN is executed?
**Answer:**
An INNER JOIN returns only the records that have matching values in both tables being joined.

#### 612. What happens when you violate referential integrity?
**Answer:**
...
#### 615. What is 'cache bloat' in a SQL server context?
**Answer:**
...
#### 616. What is 'hole-filling optimization' in the context of MERGE statements?
**Answer:**
...
#### 617. What is 4th Normal Form (4NF) regarding Multivalued Dependencies (MVDs)?
**Answer:**
...
#### 621. What is DCL and its commands?
**Answer:**
...
#### 622. What is DDL (Data Definition Language)?
**Answer:**
...
#### 623. What is DML (Data Manipulation Language)?
**Answer:**
...
#### 624. What is Data Control Language (DCL)?
**Answer:**
...
#### 625. What is Data Definition Language (DDL)?
**Answer:**
...
#### 626. What is Data Management in the context of databases?
**Answer:**
...
#### 628. What is Design by Decomposition?
**Answer:**
...
#### 629. What is Durability in ACID?
**Answer:**
...
#### 633. What is LPE in the context of database engine operations?
**Answer:**
...
#### 634. What is Microsoft Access and when should it be used?
**Answer:**
...
#### 635. What is Microsoft SQL Server?
**Answer:**
...
#### 637. What is NoSQL and its relation to traditional relational databases?
**Answer:**
...
#### 638. What is Normalization and what are its advantages?
**Answer:**
...
#### 640. What is Page Free Space (PFS) in SQL Server?
**Answer:**
...
#### 641. What is Parameter Sniffing?
**Answer:**
...
#### 642. What is Physical Database Design?
**Answer:**
...
#### 643. What is Relational Algebra?
**Answer:**
...
#### 646. What is SQL Data Definition Language (DDL)?
**Answer:**
...
#### 647. What is SQL Injection and how can you prevent it?
**Answer:**
...
#### 653. What is Scalar UDF inlining?
**Answer:**
...
#### 654. What is Scoping in the Database Life Cycle?
**Answer:**
...
#### 655. What is UML in the context of database design?
**Answer:**
...
#### 656. What is a 'Rebind' operation in query execution?
**Answer:**
...
#### 657. What is a 'Rewind' operation in query execution?
**Answer:**
An operation where the database restarts reading a spool or table from the beginning.

#### 658. What is a 'dirty read' in database transactions?
**Answer:**
...
#### 659. What is a 'poison message' in the context of SQL Server Service Broker?
**Answer:**
...
#### 660. What is a 'quantum' in the context of database engine scheduling?
**Answer:**
...
#### 661. What is a 'read-ahead read' in database performance?
**Answer:**
...
#### 663. What is a 'trivial plan' in query optimization?
**Answer:**
...
#### 667. What is a CTE (Common Table Expression)?
**Answer:**
...
#### 672. What is a Cursor in a database?
**Answer:**
...
#### 674. What is a Data Cube (multidimensional OLAP)?
**Answer:**
...
#### 675. What is a Decision Support System (DSS)?
**Answer:**
...
#### 676. What is a Decision Support System (DSS)?
**Answer:**
...
#### 677. What is a FOREIGN KEY constraint?
**Answer:**
...
#### 683. What is a JOIN and what are the main types?
**Answer:**
...
#### 684. What is a NULL value in SQL?
**Answer:**
...
#### 688. What is a Partial Dependency?
**Answer:**
...
#### 689. What is a Physical Design Advisor and how does it function?
**Answer:**
...
#### 690. What is a Plan Guide in SQL Server?
**Answer:**
...
#### 692. What is a RID (Row Identifier)?
**Answer:**
...
#### 693. What is a Relational Database?
**Answer:**
...
#### 695. What is a SQL-OS Scheduler?
**Answer:**
...
#### 697. What is a Stored Procedure?
**Answer:**
...
#### 700. What is a cardinality estimator?
**Answer:**
...
#### 701. What is a column in a relational database?
**Answer:**
...
#### 702. What is a correlated subquery?
**Answer:**
...
#### 703. What is a data anomaly in a database?
**Answer:**
...
#### 705. What is a database Session?
**Answer:**
...
#### 706. What is a database Trigger?
**Answer:**
...
#### 707. What is a database View and how do you use it?
**Answer:**
...
#### 711. What is a database staging area?
**Answer:**
...
#### 712. What is a database system development feedback loop?
**Answer:**
The process of finalizing a database development through multiple iterations of trial and error.

#### 713. What is a database table and how do you perform basic queries on it?
**Answer:**
...
#### 717. What is a database trigger?
**Answer:**
...
#### 721. What is a domain constraint?
**Answer:**
...
#### 722. What is a fact in data modeling?
**Answer:**
...
#### 723. What is a forwarding pointer?
**Answer:**
...
#### 724. What is a general constraint?
**Answer:**
...
#### 725. What is a hash_warning in SQL Server?
**Answer:**
...
#### 728. What is a key in the relational model?
**Answer:**
...
#### 729. What is a logical read in database performance monitoring?
**Answer:**
...
#### 730. What is a many-to-many relationship in database design?
**Answer:**
...
#### 731. What is a many-to-many relationship?
**Answer:**
...
#### 732. What is a multi-valued dependency (MVD)?
**Answer:**
...
#### 733. What is a nested query (subquery) in SQL?
**Answer:**
...
#### 734. What is a partial dependency and which normal form is it associated with?
**Answer:**
...
#### 735. What is a physical read in database performance monitoring?
**Answer:**
...
#### 736. What is a potential issue with (S)GAM pages in tempdb?
**Answer:**
...
#### 737. What is a predicate in SQL?
**Answer:**
...
#### 738. What is a predicate in SQL?
**Answer:**
...
#### 739. What is a primary key and how many can a table have?
**Answer:**
...
#### 744. What is a recursive stored procedure?
**Answer:**
...
#### 745. What is a relational database?
**Answer:**
...
#### 746. What is a relational database?
**Answer:**
...
#### 749. What is a row overflow page?
**Answer:**
...
#### 750. What is a self-join and how is it used?
**Answer:**
...
#### 753. What is a star schema in the context of OLAP?
**Answer:**
...
#### 760. What is a transformation rule in the context of database query processing?
**Answer:**
...
#### 761. What is a transitive dependency in database normalization?
**Answer:**
...
#### 762. What is a transitive dependency?
**Answer:**
...
#### 764. What is a view, and what is the 'WITH CHECK OPTION' clause?
**Answer:**
...
#### 766. What is an 'Extended Event' in SQL Server?
**Answer:**
...
#### 767. What is an 'exchange_spill' in SQL Server?
**Answer:**
...
#### 771. What is an IAM and an IAM chain?
**Answer:**
...
#### 772. What is an Identity column?
**Answer:**
...
#### 774. What is an Information System in the context of databases?
**Answer:**
...
#### 776. What is an ORM (Object-Relational Mapper)?
**Answer:**
...
#### 779. What is an aggregate function?
**Answer:**
...
#### 780. What is an aggregate function?
**Answer:**
...
#### 782. What is an association in UML?
**Answer:**
An association is a relationship between objects of two classes.

#### 783. What is an entity-relationship (ER) model?
**Answer:**
...
#### 784. What is an expression language in the context of databases?
**Answer:**
...
#### 786. What is auto-parameterization in an SQL engine?
**Answer:**
...
#### 789. What is causality tracking?
**Answer:**
...
#### 790. What is column selectivity?
**Answer:**
...
#### 791. What is crow's foot notation?
**Answer:**
...
#### 792. What is data flow in the context of query execution plans?
**Answer:**
...
#### 793. What is data inconsistency in a database?
**Answer:**
...
#### 800. What is external index fragmentation?
**Answer:**
...
#### 801. What is forced automatic parametrization in SQL Server?
**Answer:**
...
#### 802. What is horizontal scalability?
**Answer:**
...
#### 803. What is interleaved execution in the context of query optimization?
**Answer:**
...
#### 804. What is internal index fragmentation?
**Answer:**
...
#### 805. What is lock escalation and how can it be managed?
**Answer:**
...
#### 806. What is meant by 'control flow' in query execution?
**Answer:**
...
#### 807. What is mutual recursion in SQL?
**Answer:**
...
#### 808. What is osstress.exe?
**Answer:**
A Microsoft tool used to perform stress testing on database systems.

#### 809. What is referential integrity and how is it maintained?
**Answer:**
...
#### 810. What is referential integrity?
**Answer:**
...
#### 811. What is required to determine if a relational schema is in BCNF (Boyce-Codd Normal Form)?
**Answer:**
To determine BCNF compliance, you need the relational schema and the full set of functional dependencies.

#### 812. What is required to implement memory-optimized tables in SQL Server?
**Answer:**
You must create a Memory Optimized Filegroup and add a container of type Filestream to it.

#### 813. What is required when decomposing relations in BCNF or 4th Normal Form?
**Answer:**
...
#### 817. What is the 'OPTIMIZE FOR UNKNOWN' query hint?
**Answer:**
...
#### 818. What is the 'Read Committed Snapshot' isolation level?
**Answer:**
...
#### 821. What is the 'tipping point' in SQL Server indexing?
**Answer:**
...
#### 822. What is the 'tipping point' in database page estimation?
**Answer:**
...
#### 823. What is the Adaptive Join operator?
**Answer:**
...
#### 824. What is the Algebraizer and the Algebraizer Tree?
**Answer:**
...
#### 830. What is the DEFAULT constraint?
**Answer:**
...
#### 831. What is the DELETE command?
**Answer:**
...
#### 832. What is the DROP TABLE command?
**Answer:**
...
#### 833. What is the Double Precision data type?
**Answer:**
...
#### 834. What is the ESR (Equality, Sort, Range) Rule for composite index design?
**Answer:**
...
#### 837. What is the Global Allocation Map (GAM) page?
**Answer:**
...
#### 847. What is the MIN_GRANT_PERCENT query hint?
**Answer:**
A hint that sets the minimum desired memory grant percentage for a query.

#### 848. What is the NEWSEQUENTIALID() function?
**Answer:**
...
#### 849. What is the NOT NULL constraint?
**Answer:**
...
#### 859. What is the SQL AUTO INCREMENT property?
**Answer:**
...
#### 860. What is the SQL Server Query Store?
**Answer:**
...
#### 866. What is the Table Scan operator?
**Answer:**
...
#### 867. What is the Transitive rule for Functional Dependencies (FD)?
**Answer:**
The Transitive rule for FD states that if A→B and B→C, then A→C.

#### 868. What is the Transitivity rule for Functional Dependencies (FD)?
**Answer:**
The Transitivity rule states that if A -> B and B -> C, then A -> C.

#### 869. What is the UNIQUE constraint in SQL?
**Answer:**
...
#### 870. What is the UPDATE statement?
**Answer:**
...
#### 871. What is the [charlist] syntax used for?
**Answer:**
...
#### 872. What is the advantage of XSD over DTD regarding pointers?
**Answer:**
...
#### 873. What is the basic unit of time in SQL Server?
**Answer:**
The microsecond (μsecond).

#### 874. What is the behavior of a FULL OUTER JOIN?
**Answer:**
...
#### 875. What is the characteristic of a column where every row has a different value?
**Answer:**
This is the definition of a unique constraint or a primary key, ensuring entity integrity.

#### 876. What is the code inside a trigger called?
**Answer:**
The code within a trigger is referred to as the trigger body or the trigger action.

#### 877. What is the compilation cost of the MERGE statement compared to standard DML?
**Answer:**
...
#### 878. What is the correct SQL statement to return the sum of the spent amount (Samnt) for clients whose name contains 'Simpson'?
**Answer:**
SELECT SUM(Samnt) as SimpsonsSpending FROM Clients WHERE Cname LIKE '%Simpson%';

#### 879. What is the correct SQL statement to return the sum of the spent amount (Samnt) for the client 'Herb Simpson'?
**Answer:**
...
#### 880. What is the correct logical order of the main clauses in a SQL SELECT statement?
**Answer:**
The logical order is SELECT, FROM, WHERE.

#### 881. What is the correct syntax order when defining columns in a CREATE TABLE statement?
**Answer:**
The standard order is: column_name data_type(size) constraint_name.

#### 882. What is the danger of an UPDATE statement without a WHERE clause?
**Answer:**
...
#### 883. What is the default access mode for transactions if not specified?
**Answer:**
READ WRITE is the default access mode.

#### 884. What is the default maximum memory grant for a SQL Server query?
**Answer:**
The default maximum memory grant is typically 20% of the total available server memory.

#### 885. What is the default sort order for SQL records?
**Answer:**
The default order is ascending (ASC).

#### 886. What is the definition of Third Normal Form (3NF)?
**Answer:**
...
#### 887. What is the definition of the Character Data type?
**Answer:**
...
#### 891. What is the difference between 'well-formed' and 'valid' XML?
**Answer:**
...
#### 892. What is the difference between BETWEEN and IN operators?
**Answer:**
...
#### 893. What is the difference between CPU time and Elapsed time?
**Answer:**
...
#### 894. What is the difference between CREATE TABLE, INSERT INTO, and SELECT DISTINCT?
**Answer:**
...
#### 895. What is the difference between Clustered and Non-Clustered Indexes?
**Answer:**
...
#### 896. What is the difference between Composition and Aggregation in UML?
**Answer:**
...
#### 897. What is the difference between DELETE+OUTPUT and SELECT+DELETE?
**Answer:**
...
#### 898. What is the difference between FULL OUTER JOIN and UNION?
**Answer:**
...
#### 899. What is the difference between Hash Match joins and Merge joins?
**Answer:**
...
#### 900. What is the difference between INNER JOIN and OUTER JOIN?
**Answer:**
...
#### 901. What is the difference between MS SQL and other database engines like Oracle or MySQL?
**Answer:**
...
#### 902. What is the difference between NULL, zero, and blank space?
**Answer:**
...
#### 903. What is the difference between OLAP and OLTP databases?
**Answer:**
...
#### 904. What is the difference between OLTP and OLAP?
**Answer:**
...
#### 905. What is the difference between Primary Keys and Foreign Keys?
**Answer:**
...
#### 906. What is the difference between READ ONLY and READ WRITE transaction qualifiers?
**Answer:**
...
#### 907. What is the difference between SQL and NoSQL?
**Answer:**
...
#### 908. What is the difference between SQL and PL/SQL?
**Answer:**
...
#### 909. What is the difference between SQL, MySQL, and SQL Server?
**Answer:**
...
#### 910. What is the difference between UNION and UNION ALL?
**Answer:**
...
#### 911. What is the difference between UNION and UNION ALL?
**Answer:**
...
#### 912. What is the difference between WHERE and HAVING clauses?
**Answer:**
...
#### 913. What is the difference between WHERE and HAVING clauses?
**Answer:**
...
#### 914. What is the difference between a 'predicate' and a 'seek predicate' in an execution plan?
**Answer:**
...
#### 915. What is the difference between a Cross Join and a Natural Join?
**Answer:**
...
#### 916. What is the difference between a DBMS and a database system?
**Answer:**
...
#### 917. What is the difference between a Function and a Stored Procedure?
**Answer:**
...
#### 918. What is the difference between a Page IO latch and a Page latch?
**Answer:**
...
#### 919. What is the difference between a Primary Key and a Foreign Key?
**Answer:**
...
#### 920. What is the difference between a Primary Key and a Unique Key?
**Answer:**
...
#### 921. What is the difference between a UNIQUE and non-UNIQUE clustered index?
**Answer:**
...
#### 922. What is the difference between a logical and a physical operator?
**Answer:**
...
#### 923. What is the difference between a trivial and non-trivial functional dependency A -> B?
**Answer:**
A dependency is trivial if B is a subset of A. It is non-trivial if B is not a subset of A.

#### 924. What is the difference between aggregate and scalar functions?
**Answer:**
...
#### 925. What is the difference between attribute-based and tuple-based check constraints?
**Answer:**
...
#### 926. What is the difference between data mining and data warehousing, and what are common warehouse application types?
**Answer:**
...
#### 927. What is the difference between forward and backward index scans?
**Answer:**
Forward index scans can be parallelized, whereas backward index scans generally cannot.

#### 928. What is the difference between nvarchar(100) and nvarchar(max) in MS SQL?
**Answer:**
...
#### 929. What is the difference between row-level and statement-level triggers?
**Answer:**
...
#### 930. What is the difference between single quotes ('') and double quotes ("") in standard SQL?
**Answer:**
...
#### 931. What is the difference between system and user databases?
**Answer:**
...
#### 932. What is the difference between the SELECT and WHERE clauses?
**Answer:**
...
#### 933. What is the difference between the SQL standard transaction level and actual DBMS default implementations?
**Answer:**
...
#### 934. What is the difference between using a Function and a View?
**Answer:**
...
#### 935. What is the difference between well-formed XML and valid XML?
**Answer:**
...
#### 936. What is the difference in categorization between '2002-01-25 20:20:01.001', '2002-01-25', and '22:10:15.3239999'?
**Answer:**
...
#### 937. What is the effect of creating a stored procedure with a '#' prefix?
**Answer:**
The procedure is created as a temporary object stored in tempdb.

#### 938. What is the fastest collation?
**Answer:**
...
#### 939. What is the formal definition of Isolation/Serializability in transactions?
**Answer:**
...
#### 940. What is the function of GAM and SGAM pages in SQL Server?
**Answer:**
...
#### 941. What is the function of sp_recompile?
**Answer:**
...
#### 942. What is the function of the 'WITH ENCRYPTION' option in database programmability?
**Answer:**
...
#### 943. What is the function of the ALTER TABLE statement?
**Answer:**
...
#### 947. What is the function of the IN operator in a WHERE clause?
**Answer:**
...
#### 948. What is the function of the INSERT statement?
**Answer:**
...
#### 949. What is the function of the LIKE operator in SQL?
**Answer:**
...
#### 950. What is the function of the ORDER BY clause in SQL?
**Answer:**
The ORDER BY clause specifies the column(s) used to sort the resulting data set.

#### 951. What is the function of the READ ONLY transaction state?
**Answer:**
...
#### 952. What is the function of the SUM aggregate function in SQL?
**Answer:**
The SUM() function returns the total sum of all numerical values for a given column or expression.

#### 953. What is the function of the WITH statement in SQL?
**Answer:**
...
#### 954. What is the function of the command: ALTER DATABASE ... WITH ROLLBACK IMMEDIATE?
**Answer:**
...
#### 955. What is the goal of a good database design regarding Functional Dependencies (FDs)?
**Answer:**
...
#### 956. What is the impact of using indexes on frequently queried attributes?
**Answer:**
Using indexes on frequently queried attributes can provide a massive improvement in query performance.

#### 957. What is the industry convention for naming SQL identifiers?
**Answer:**
...
#### 958. What is the lifecycle behavior of temporary objects in stored procedures?
**Answer:**
Upon procedure termination, temporary tables are truncated to one extent, but their statistics are retained.

#### 959. What is the limitation on row size in SQL Server?
**Answer:**
A single row must fit within a single page, which is 8,060 bytes.

#### 960. What is the logical order of clauses in a SQL SELECT statement?
**Answer:**
...
#### 961. What is the logical order of keywords in a SQL query?
**Answer:**
The order is: SELECT, FROM, JOIN, WHERE, GROUP BY, HAVING, ORDER BY, LIMIT (or TOP).

#### 962. What is the minimal information needed when defining a table?
**Answer:**
A table must have a unique Table Name, and at least one Column Name with an associated Data Type.

#### 963. What is the naming convention 'sp' (e.g., spXXX) in SQL procedures?
**Answer:**
...
#### 964. What is the nature of a WHERE predicate in a filtered index?
**Answer:**
...
#### 965. What is the objective of a Data Manipulation Language (DML)?
**Answer:**
...
#### 966. What is the objective of a query language?
**Answer:**
...
#### 967. What is the opposite of LIKE?
**Answer:**
...
#### 968. What is the output of the SQL Parser?
**Answer:**
The output is a parse tree representing the logical structure of the SQL statement.

#### 969. What is the potential performance issue when using a filtered index with an IS NULL predicate?
**Answer:**
...
#### 970. What is the primary motivation behind the use of triggers?
**Answer:**
...
#### 971. What is the primary objective of Query Planning/Optimization?
**Answer:**
The main objective is to implement the most efficient use of indexes and execution paths to retrieve data.

#### 972. What is the primary role of XSLT and what does the acronym stand for?
**Answer:**
...
#### 973. What is the primary use of Normalization and how does it prevent data anomalies?
**Answer:**
...
#### 974. What is the purpose of CREATE INDEX and the 'DROP_EXISTING = ON' option?
**Answer:**
...
#### 975. What is the purpose of DBCC PAGE?
**Answer:**
...
#### 976. What is the purpose of Database Normalization?
**Answer:**
...
#### 977. What is the purpose of Views in a database?
**Answer:**
...
#### 978. What is the purpose of a CHECK constraint?
**Answer:**
...
#### 981. What is the purpose of a mission statement and mission objectives in database planning?
**Answer:**
...
#### 982. What is the purpose of a primary key and how does it relate to foreign keys?
**Answer:**
...
#### 983. What is the purpose of an SQL Clause (e.g., WHERE, HAVING)?
**Answer:**
...
#### 984. What is the purpose of an SQL index and how do you create one?
**Answer:**
...
#### 985. What is the purpose of an XSLT template for recursive element copying?
**Answer:**
...
#### 986. What is the purpose of an index in a database?
**Answer:**
...
#### 987. What is the purpose of database transactions and how are they used?
**Answer:**
...
#### 988. What is the purpose of functional dependencies in database systems?
**Answer:**
...
#### 989. What is the purpose of procedures and functions in a database?
**Answer:**
...
#### 990. What is the purpose of square brackets [..] in XPath?
**Answer:**
Square brackets [..] allow for the specification of a condition (predicates) to filter nodes.

#### 991. What is the purpose of the 'DELETE' statement?
**Answer:**
...
#### 992. What is the purpose of the 'SELECT INTO' statement?
**Answer:**
...
#### 993. What is the purpose of the 'UPDATE' statement?
**Answer:**
...
#### 994. What is the purpose of the 'dbo' schema in Microsoft SQL Server, and why are schemas used?
**Answer:**
...
#### 995. What is the purpose of the := operator in SQL?
**Answer:**
...
#### 996. What is the purpose of the AS clause?
**Answer:**
...
#### 1000. What is the purpose of the CREATE INDEX statement and how do you create a unique index?
**Answer:**
...
#### 1001. What is the purpose of the DBCC TRACEON command?
**Answer:**
...
#### 1002. What is the purpose of the DEFAULT constraint?
**Answer:**
...
#### 1003. What is the purpose of the DISTINCT keyword?
**Answer:**
...
#### 1004. What is the purpose of the EXISTS operator?
**Answer:**
...
#### 1008. What is the purpose of the INSERT statement in SQL?
**Answer:**
...
#### 1012. What is the purpose of the Lookup Transformation?
**Answer:**
...
#### 1013. What is the purpose of the MAX_GRANT_PERCENT query hint?
**Answer:**
...
#### 1014. What is the purpose of the MERGE statement?
**Answer:**
...
#### 1015. What is the purpose of the SELECT statement?
**Answer:**
The SELECT statement is used to retrieve and display data from one or more database tables.

#### 1016. What is the purpose of the SELECT statement?
**Answer:**
...
#### 1017. What is the purpose of the SQL ROLLBACK statement?
**Answer:**
...
#### 1018. What is the purpose of the TRIGGER_NESTLEVEL function?
**Answer:**
...
#### 1019. What is the purpose of the UNIQUE constraint?
**Answer:**
...
#### 1020. What is the purpose of the WHERE clause?
**Answer:**
It is used to filter records that fulfill a specified criterion.

#### 1021. What is the purpose of the WITH GRANT option?
**Answer:**
...
#### 1022. What is the purpose of the model database in SQL Server?
**Answer:**
...
#### 1023. What is the purpose of trace flag 8780 in SQL Server?
**Answer:**
...
#### 1024. What is the purpose of using brackets [ ] in database identifiers?
**Answer:**
...
#### 1025. What is the recommended naming convention for database tables and views?
**Answer:**
Use singular nouns rather than plural (e.g., 'movie' instead of 'movies').

#### 1026. What is the relational algebra select operator and what does it do?
**Answer:**
...
#### 1027. What is the relationship between Functional Dependency (FD) and Multivalued Dependency (MVD)?
**Answer:**
...
#### 1028. What is the relationship between a trigger and a procedure or function?
**Answer:**
...
#### 1029. What is the relationship between multi-valued dependencies and fourth normal form (4NF)?
**Answer:**
...
#### 1030. What is the relative power of XQuery compared to XPath and XSLT?
**Answer:**
XQuery offers the most expressive power because it is a full-featured, compositional query language.

#### 1031. What is the requirement for a foreign key in most current DBMS?
**Answer:**
...
#### 1032. What is the requirement for a table to be in BCNF (Boyce-Codd Normal Form)?
**Answer:**
For every non-trivial functional dependency A->B, A must be a superkey.

#### 1033. What is the result of an INNER JOIN, LEFT JOIN, RIGHT JOIN, and FULL OUTER JOIN?
**Answer:**
...
#### 1034. What is the role of Consistency in database transactions?
**Answer:**
...
#### 1035. What is the role of the Algebraizer in the SQL Server relational engine?
**Answer:**
...
#### 1036. What is the role of the row offsets table?
**Answer:**
...
#### 1037. What is the rule for translating UML classes to relational schemas regarding primary keys?
**Answer:**
...
#### 1038. What is the scope of an aggregate function?
**Answer:**
...
#### 1045. What is the standard order of clauses in a comprehensive SELECT statement?
**Answer:**
The standard sequence is: SELECT, DISTINCT, FROM & JOIN, WHERE, GROUP BY, HAVING, ORDER BY, and LIMIT.

#### 1046. What is the subtree cost of an operator in an execution plan?
**Answer:**
...
#### 1047. What is the syntax and purpose of a window function?
**Answer:**
...
#### 1048. What is the syntax for the AVG() function?
**Answer:**
...
#### 1049. What is the syntax for the HAVING clause?
**Answer:**
...
#### 1055. What is the syntax for writing comments in SQL?
**Answer:**
Use double dashes for single-line comments: -- This is a comment.

#### 1056. What is the syntax to create a join table?
**Answer:**
...
#### 1057. What is the syntax to manipulate records (INSERT, UPDATE, DELETE)?
**Answer:**
...
#### 1058. What is the syntax to modify database structures (CREATE, ALTER, DROP)?
**Answer:**
...
#### 1059. What is the syntax to reference columns from different tables when names overlap?
**Answer:**
Use table qualification syntax: table_name.column_name. Example: SELECT cats.name, dogs.name FROM cats, dogs;

#### 1060. What is the theta-join operator in relational algebra?
**Answer:**
...
#### 1061. What is the trade-off when using weaker transaction isolation levels?
**Answer:**
...
#### 1065. What is three-valued logic in SQL?
**Answer:**
...
#### 1066. What is vertical partitioning?
**Answer:**
...
#### 1067. What is vertical scalability?
**Answer:**
...
#### 1068. What issue can occur when comparing char and nchar columns with SQL_* collations?
**Answer:**
...
#### 1069. What items are contained within an SQL package, and what are its two main parts?
**Answer:**
...
#### 1070. What latching issue is associated with identity primary keys?
**Answer:**
...
#### 1071. What limitations exist for creating an updateable view?
**Answer:**
...
#### 1072. What methods can be used to update a table via SSIS?
**Answer:**
...
#### 1076. What parameters can SELECT TOP use to limit records?
**Answer:**
SELECT TOP can limit records by a specific absolute number or by a percentage of the total result set.

#### 1077. What quantification does XPath use by default for attribute comparisons?
**Answer:**
XPath relies on implicit existential quantification ('there exists') when comparing attributes (e.g., [attribute = value]).

#### 1078. What questions should you ask during a BI Stakeholder Analysis and Business Context review?
**Answer:**
...
#### 1079. What requirement must be met before adding a Primary Key to an existing table using ALTER TABLE?
**Answer:**
The target column(s) must have already been defined as NOT NULL.

#### 1080. What set operators are used to process logical 'only', 'and', and 'or' relationships across result sets?
**Answer:**
EXCEPT (\diff) is used for 'only' or exclusion, INTERSECT for 'and' (intersection), and UNION for 'or' (merging ensembles).

#### 1081. What statement is used to fetch data from a database?
**Answer:**
...
#### 1082. What two mechanisms define how transactions are handled in standard SQL?
**Answer:**
...
#### 1083. What types of indexes are available in SQL Server?
**Answer:**
...
#### 1084. What types of triggers exist in SQL Server?
**Answer:**
...
#### 1088. When are association classes considered unnecessary?
**Answer:**
...
#### 1089. When are quotes required for values in SQL queries?
**Answer:**
Numeric fields generally do not require quotes around values, while text fields generally require single quotes.

#### 1090. When are two sets of functional dependencies (S1 and S2) considered equivalent?
**Answer:**
...
#### 1091. When defining a character string column, what does the specified length indicate?
**Answer:**
The specified length indicates the maximum number of characters that the column can hold.

#### 1092. When designing an application, how do you decide between a NoSQL system and a relational DBMS regarding data consistency and scalability?
**Answer:**
...
#### 1093. When does SQL Server use 'density' in query optimization?
**Answer:**
...
#### 1096. When does a set of functional dependencies S2 follow from S1?
**Answer:**
...
#### 1097. When is an execution plan built in relation to variable substitution?
**Answer:**
...
#### 1098. When is it appropriate to use a Cursor?
**Answer:**
...
#### 1099. When is the exact numeric data type used?
**Answer:**
...
#### 1100. When is using a table alias useful?
**Answer:**
...
#### 1101. When should you use a view instead of a base table?
**Answer:**
...
#### 1102. When should you use date/time data types?
**Answer:**
Use date/time data types when you need to define a specific point in time with a required degree of accuracy.

#### 1103. Where can aggregate functions be used in an SQL query?
**Answer:**
Aggregate functions can be used in the SELECT list and the HAVING clause.

#### 1104. Where can information about SQL Server wait types be found?
**Answer:**
Wait types are documented in the system view sys.dm_os_wait_stats.

#### 1105. Where can one check if a scalar function is inlineable in SQL Server?
**Answer:**
In the sys.sql_modules system catalog view.

#### 1106. Which Normal Form requires that all non-key fields are dependent only on the candidate key?
**Answer:**
BCNF (Boyce-Codd Normal Form) requires that for every functional dependency X -> Y, X must be a superkey.

#### 1107. Which Normal Form validates functional and multivalued dependencies?
**Answer:**
Fourth Normal Form (4NF).

#### 1108. Which Normal Form validates functional dependencies between key attributes?
**Answer:**
Boyce-Codd Normal Form (BCNF).

#### 1109. Which SQL clause is used to limit the number of records returned by a query?
**Answer:**
The SELECT TOP clause (or LIMIT/FETCH FIRST depending on the SQL dialect).

#### 1110. Which SQL clause uses the logical operators AND, OR, and NOT, and in what order are they evaluated?
**Answer:**
These operators are used in the WHERE clause. The evaluation order is NOT, followed by AND, followed by OR.

#### 1111. Which SQL clauses are disallowed in updateable views?
**Answer:**
The clauses DISTINCT, GROUP BY, HAVING, and UNION are generally not allowed in updateable views.

#### 1112. Which SQL privileges can be granted to other users?
**Answer:**
...
#### 1113. Which SQL statement is used to remove one or more rows from a named table?
**Answer:**
The DELETE statement.

#### 1114. Which SQL statement is used when we want to abort a transaction?
**Answer:**
The ROLLBACK statement.

#### 1115. Which actions prevent the caching of temporary objects in SQL Server?
**Answer:**
Actions such as creating an index, running ALTER TABLE, or defining a named constraint prevent caching.

#### 1116. Which aggregate functions ignore NULL values?
**Answer:**
SUM, AVG, MIN, and MAX ignore NULL values during calculation.

#### 1117. Which anomalies can persist in 2NF?
**Answer:**
Delete anomalies can still occur in 2NF, although Insert and Update anomalies are typically resolved.

#### 1118. Which data type handles non-exact numbers?
**Answer:**
Approximate numeric data types (such as FLOAT or REAL).

#### 1119. Which data type is used for bit strings?
**Answer:**
The BIT or BIT VARYING data type.

#### 1120. Which data type is used for exact numeric representation?
**Answer:**
...
#### 1121. Which data type should be used for monetary values like '1001.99'?
**Answer:**
...
#### 1132. Why are low cardinality columns poor candidates for solo indexing?
**Answer:**
...
#### 1133. Why are materialized views often used in OLAP?
**Answer:**
...
#### 1134. Why are square brackets [ ] used with database objects?
**Answer:**
...
#### 1135. Why can only relations with a composite candidate key violate 2NF?
**Answer:**
...
#### 1136. Why do SQL functions on indexed columns disable index usage?
**Answer:**
...
#### 1137. Why do we need joins, and what is the syntax for a basic INNER JOIN?
**Answer:**
...
#### 1138. Why do we use integrity constraints?
**Answer:**
...
#### 1139. Why does comparing dates with time components in SQL often fail?
**Answer:**
...
#### 1140. Why does the statement 'CREATE TABLE Person (PersonName nvarchar());' fail and how can it be fixed?
**Answer:**
...
#### 1141. Why is a relation not in 2NF if a non-key attribute depends on only a subset of the candidate key?
**Answer:**
...
#### 1142. Why is a table with a single-attribute primary key automatically in 2NF if it is in 1NF?
**Answer:**
...
#### 1143. Why is it often preferable to use constraints instead of triggers?
**Answer:**
...
#### 1144. Why is modification via views not always systematically automated?
**Answer:**
...
#### 1145. Why is querying XML considered less mature than SQL?
**Answer:**
...
#### 1146. Why is strict data typing important in database design?
**Answer:**
...
#### 1149. Why might a predicate in an index seek operator be inefficient?
**Answer:**
...
#### 1150. Why must the correct ROUTE be set on both sides of a Service Broker DIALOG?
**Answer:**
...
#### 1151. Why would a relation fail 3NF?
**Answer:**
...
#### 1152. Write a query filtering with BETWEEN and additional operators.
**Answer:**
...
#### 1153. Write a query joining Invoices and Customers to retrieve invoice details and referrer names.
**Answer:**
...
#### 1154. Write a query to calculate the total score of hackers based on the maximum score of their submissions, excluding those with a total score of 0, ordered by score (desc) and hacker_id (asc).
**Answer:**
...
#### 1155. Write a query to find URLs that start with any character, have '://', contain a character before and after, and end in '.org'.
**Answer:**
...
#### 1156. Write a statement to add a column 'Comments' of data type nvarchar(4000) that allows null values to be inserted to table 'Clients'.
**Answer:**
...
#### 1157. sys.dm_db_index_operational_stats
**Answer:**
...
#### 1158. sys.dm_db_index_physical_stats
**Answer:**
...
#### 1159. sys.dm_db_index_usage_stats
**Answer:**
...
#### 1162. sys.dm_exec_query_optimizer_info
**Answer:**
...
#### 1172. sys.system_internals_allocation_units
**Answer:**
